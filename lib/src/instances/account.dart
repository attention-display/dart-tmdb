...
class AccountMovieWatchlist {
  ...
  AccountMovieWatchlist.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    if (json['results'] != null) {
      results = <AccountFavoriteMoviesResults>[];
      json['results'].forEach((v) {
...
class AccountTVShowsWatchlist {
  int? page;
  List<AccountFavoriteTVShowsResults>? results;
  int? totalPages;
  int? totalResults;

  AccountTVShowsWatchlist(
      {this.page, this.results, this.totalPages, this.totalResults});

  AccountTVShowsWatchlist.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    if (json['results'] != null) {
      results = <AccountFavoriteTVShowsResults>[];
      json['results'].forEach((v) {
